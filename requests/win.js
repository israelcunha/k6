...
export const options = {
    // LoadTest
    stages: [
      { duration: '20s', target: 6 }, // Aumenta para 6 usuários em 1m
      { duration: '10s', target: 8}, // Mantem os 6 usuários em 1m
      { duration: '5s', target: 10}, // Aumenta para 10 usuários em 1m
      { duration: '10s', target: 0}, // Mantem os 10 usuários em 1m
